             ...
             <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
                 ...
                 <ul className='list-none hidden sm:flex  flex-row-reverse gap-10'>
                    {socialNavLinks.map((link) => (
                        ...
                        <a href={`${link.meta_url}`}><img src={`${link.icon}`} className="w-13 h-6 object-contain lg:flex hidden "/></a>
                        </li>
                    ))}
                    </ul>
                ...
                <div className='sm:hidden flex flex-1 justify-end items-center'>
                    ...
                    <ul className=' sm:hidden justify-end items-start flex flex-col gap-4'>
                    {navLinks.map((link) => (
